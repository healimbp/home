...
const targetDirs = [
  'c:/Users/PC/Downloads/home/static/blog-images/cheongna-anxiety',
  ...
  <g transform="translate(55, 135)">
    ...
    <g transform="translate(55, 530)">
      ...
      <text x="145" y="118" font-family="${fontFamilies}" font-size="15" fill="#4b635a">
        "불안은 마음의 나약함이 아닌 뇌신경계의 과열 신호입니다. 근본 치료로 평온한 일상을 되찾아드립니다."
      </text>
      <text x="145" y="145" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#b45309">
        📍 부평역 7번 출구 도보 5분 (청라·서구 인접) | 월·수·금 야간진료 (저녁 8시까지)
      </text>
    </g>
    ...
    <g transform="translate(55, 735)">
      ...
      <text x="430" y="45" font-family="${fontFamilies}" font-size="15" font-weight="bold" fill="#2d6a59" text-anchor="middle" letter-spacing="0.5">
        #청라불안장애 #청라불안장애한의원 #인천서구불안장애 #청라공황장애 #자율신경실조증 #해아림한의원부평점
      </text>
    </g>
  </g>
</svg>
...
<svg width="1080" height="1080" viewBox="0 0 1080 1080" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(60, 50)">
    ...
    <text x="0" y="125" font-family="${fontFamilies}" font-size="20" fill="#a7f3d0">
      마음의 나약함이 아니라 뇌 신경계의 화재경보기(편도체)가 과각성된 상태입니다
    </text>
  </g>
  ...
  <g transform="translate(60, 205)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="140" y="105" font-family="${fontFamilies}" font-size="17" fill="#475569">
        • 뇌의 공포·불안 담당 부위인 <tspan font-weight="bold" fill="#0369a1">편도체(Amygdala)</tspan>가 만성 스트레스로 과열됩니다.
      </text>
    ...
    <g transform="translate(0, 255)">
      ...
      <text x="140" y="105" font-family="${fontFamilies}" font-size="17" fill="#475569">
        • 편도체 흥분 신호가 척수를 타고 내려와 <tspan font-weight="bold" fill="#b91c1c">교감신경(전투 모드)</tspan>을 과도하게 자극합니다.
      </text>
      <text x="140" y="137" font-family="${fontFamilies}" font-size="17" fill="#475569">
  ...
  <g transform="translate(60, 185)">
    ...
    <g transform="translate(40, 35)">
      ...
      <text x="90" y="75" font-family="${fontFamilies}" font-size="15" fill="#475569">
        • "혹시 안 좋은 일이 생기면 어쩌지?" 등 일어나지 않은 일에 대한 과도한 예기불안
      </text>
    ...
    <g transform="translate(40, 180)">
      ...
      <text x="90" y="75" font-family="${fontFamilies}" font-size="15" fill="#475569">
        • 심장내과 검사를 받아도 '이상 없음' 판정이 나오지만, 가슴 답답함과 과호흡 반복
      </text>
      <text x="90" y="98" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#0d9488">
        ▶ [급성 신체화형]: 교감신경 과항진으로 인한 자율신경실조증 연계
      </text>
    </g>
    ...
    <g transform="translate(40, 470)">
      ...
      <text x="90" y="75" font-family="${fontFamilies}" font-size="15" fill="#475569">
        • 잠들기 직전 각성 뇌파가 치솟아 입면장애가 생기고, 자다가도 불안감에 자주 깸
      </text>
      <text x="90" y="98" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#0d9488">
    ...
    <g transform="translate(40, 615)">
      ...
      <text x="47" y="55" font-family="${fontFamilies}" font-size="24" font-weight="bold" fill="#ffffff" text-anchor="middle">✓</text>
      <text x="90" y="45" font-family="${fontFamilies}" font-size="21" font-weight="bold" fill="#0f2922">
        5. 긴장되는 모임이나 운전, 낯선 장소, 대중교통을 자꾸 피하게 된다
      </text>
      <text x="90" y="75" font-family="${fontFamilies}" font-size="15" fill="#475569">
...
<svg width="1080" height="1080" viewBox="0 0 1080 1080" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(60, 185)">
    ...
    <g transform="translate(495, 0)">
      ...
      <text x="45" y="300" font-family="${fontFamilies}" font-size="14" fill="#16a34a">
        심비(心脾) 기혈을 보하고 교감신경을 안정시켜 불안 역치값을 정상화
      </text>
    </g>
    ...
    <g transform="translate(0, 400)">
      ...
      <text x="75" y="55" font-family="${fontFamilies}" font-size="16" font-weight="bold" fill="#b45309" text-anchor="middle">STEP 03</text>
      ...
      <text x="30" y="145" font-family="${fontFamilies}" font-size="16" fill="#475569">
        • 과각성된 High-Beta파 억제 훈련
      </text>
      <text x="30" y="175" font-family="${fontFamilies}" font-size="16" fill="#475569">
        • 마음을 안정시키는 SMR/Alpha파 강화
      </text>
      <text x="30" y="205" font-family="${fontFamilies}" font-size="16" fill="#475569">
        • 호흡 기반 자율신경 이완 피드백
      </text>
      <rect x="30" y="240" width="405" height="105" rx="14" fill="#fffbeb" />
      <text x="45" y="270" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#b45309">
        🎯 치료 목표
      </text>
      <text x="45" y="300" font-family="${fontFamilies}" font-size="14" fill="#d97706">
        외부 스트레스 자극이 와도 뇌가 스스로 안정을 유지하는 회복 탄력성 형성
      </text>
    </g>
    ...
    <g transform="translate(495, 400)">
      <rect x="0" y="0" width="465" height="380" rx="24" fill="#ffffff" filter="url(#shadow4)" />
      <rect x="30" y="30" width="90" height="36" rx="8" fill="#f3e8ff" />
      <text x="75" y="55" font-family="${fontFamilies}" font-size="16" font-weight="bold" fill="#7e22ce" text-anchor="middle">STEP 04</text>
      <circle cx="400" cy="50" r="26" fill="#faf5ff" />
      <text x="400" y="58" font-family="${fontFamilies}" font-size="26" text-anchor="middle">✨</text>
      ...
      <rect x="30" y="240" width="405" height="105" rx="14" fill="#faf5ff" />
      <text x="45" y="270" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#7e22ce">
        🎯 치료 목표
      </text>
      <text x="45" y="300" font-family="${fontFamilies}" font-size="14" fill="#9333ea">
        몸의 근육 긴장을 해소하고 뇌로 가는 혈류를 개선하여 신체화 증상 신속 진정
      </text>
    </g>
  </g>
  ...
  <g transform="translate(60, 995)">
    <rect x="0" y="0" width="960" height="46" rx="14" fill="#042f2c" />
    <text x="480" y="30" font-family="${fontFamilies}" font-size="17" font-weight="bold" fill="#a7f3d0" text-anchor="middle">
      🌿 뇌 자생력 회복으로 재발 걱정 없는 평온한 일상을 약속드립니다.
    </text>
  </g>
</svg>
  `;
...
// 5. POINT 04: 생활 속 현실적 실천 팁 카드 (약선차 제외)
  ...
  <g transform="translate(60, 205)">
    ...
    <g transform="translate(0, 0)">
      ...
      <text x="165" y="186" font-family="${fontFamilies}" font-size="15" font-weight="bold" fill="#0284c7">
        👉 실천: 청라 도로 운전 중이나 회의실에서 불안이 치솟을 때 주변 사물을 하나씩 세어보세요.
      </text>
    </g>
    ...
    <g transform="translate(0, 520)">
      ...
      <text x="150" y="65" font-family="${fontFamilies}" font-size="24" font-weight="bold" fill="#92400e">
        3. 손목 안쪽 '내관혈(內關穴)' 지압 &amp; 4-7-8 호흡법
      </text>
      <text x="150" y="105" font-family="${fontFamilies}" font-size="17" fill="#475569">
        • 손목 안쪽 주름에서 위로 3마디 올라온 두 힘줄 사이를 누르며 4초 흡기-7초 멈춤-8초 호기.
      </text>
      <text x="150" y="137" font-family="${fontFamilies}" font-size="17" fill="#475569">
...
async function main() {
  console.log('Generating Cheongna Anxiety blog cards (1080x1080)...');
  ...
  console.log('All 5 Cheongna Anxiety cards rendered successfully!');
}
