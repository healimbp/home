...
const targetDirs = [
  'c:/Users/PC/Downloads/home/static/blog-images/incheon-anxiety',
...
<svg width="1080" height="1080" viewBox="0 0 1080 1080" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(540, 65)">
    ...
    <text x="0" y="31" font-family="${fontFamilies}" font-size="20" font-weight="bold" fill="#ffffff" text-anchor="middle" letter-spacing="1">🌿 인천 신경정신과 · 뇌신경 불안장애 클리닉</text>
  </g>
  ...
  <g transform="translate(55, 135)">
    ...
    <g transform="translate(55, 735)">
      ...
      <text x="430" y="45" font-family="${fontFamilies}" font-size="15" font-weight="bold" fill="#2d6a59" text-anchor="middle" letter-spacing="0.5">
        #인천신경정신과 #인천불안장애 #인천불안장애한의원 #부평신경정신과 #자율신경실조증 #해아림한의원인천부평점
      </text>
    </g>
  </g>
</svg>
  ...
  <g transform="translate(60, 185)">
    ...
    <g transform="translate(40, 35)">
      ...
      <text x="90" y="98" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#0d9488">
        ▶ [만성 범불안형]: 일상 업무와 대인관계 집중력을 급격히 저하시킴
      </text>
    </g>
    ...
    <g transform="translate(40, 615)">
      ...
      <text x="90" y="75" font-family="${fontFamilies}" font-size="15" fill="#475569">
        • "거기서 또 불안해지면 어쩌지?" 하는 예기불안으로 인해 활동 반경이 점점 좁아짐
      </text>
      <text x="90" y="98" font-family="${fontFamilies}" font-size="14" font-weight="bold" fill="#0d9488">
...
async function main() {
  console.log('Generating Incheon Neuropsychiatry Anxiety blog cards...');
  ...
  console.log('All 5 cards successfully generated!');
}
