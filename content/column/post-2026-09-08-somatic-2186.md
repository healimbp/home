---
title: "시험이나 미팅 직전 배가 살살 아프고 가스 차는 과민성대장증후군 뇌-장 치료 (인천 루원시티 치료 가이드)"
...
<div class="toc">
  ...
  <ol>
    <li>과민성대장증후군 및 뇌-장 신경망의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 과민성대장증후군 및 뇌-장 신경망의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 과민성대장증후군 및 뇌-장 신경망의 악순환 진행 고리</div>
...
<div class="space-y-4 my-6 not-prose">
    <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] shadow-sm space-y-2">
      <div class="font-extrabold text-sm sm:text-base text-[#202947] flex items-start gap-2.5">
        ...
        <span>대장내시경 검사에서는 깨끗하다는데 왜 만성 복통과 설사/변비가 반복되나요?</span>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8 m-0">
        과민대장증후군은 대장 점막의 궤양이나 염증이 아닌, 장의 운동성과 신경 감각의 기능적 이상이기 때문입니다. 장의 자율 조절력을 회복시키는 한방 치료로 깨끗하게 완치될 수 있습니다.
      </p>
    </div>
    <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] shadow-sm space-y-2">
      <div class="font-extrabold text-sm sm:text-base text-[#202947] flex items-start gap-2.5">
        <span class="bg-[#2F5D50] text-white text-xs px-2 py-0.5 rounded-md font-bold shrink-0 mt-0.5">Q2</span>
        <span>시험이나 미팅 직전 긴장만 하면 배가 살살 아프고 화장실로 달려가 설사를 하는 과민성대장증후군(IBS)은 왜 생기나요?</span>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8 m-0">
        뇌와 장이 미주신경으로 직통 연결된 "뇌-장 신경 축(Gut-Brain Axis)"의 과민 반응입니다. 뇌의 사소한 스트레스 신호가 장 신경총을 과도하게 자극하여 비정상적인 장 경련을 일으키기 때문입니다. 장만 치료할 것이 아니라 뇌 자율신경을 안정시키는 평간건비(平肝健脾) 한약이 필수적입니다.
      </p>
    </div>
    <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] shadow-sm space-y-2">
      <div class="font-extrabold text-sm sm:text-base text-[#202947] flex items-start gap-2.5">
        <span class="bg-[#2F5D50] text-white text-xs px-2 py-0.5 rounded-md font-bold shrink-0 mt-0.5">Q3</span>
        <span>가스가 차서 배가 빵빵하고 잦은 방귀와 복통으로 대인관계가 두려운데 식단 관리는 어떻게 해야 하나요?</span>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8 m-0">
        장내에서 발효되어 가스를 많이 만드는 고포드맵(FODMAP) 식품(생양파, 마늘, 콩류, 우유, 밀가루, 사과 등)을 피하고, 따뜻한 성질의 저포드맵 식단과 온열 복부 뜸 치료를 병행해야 합니다.
      </p>
    </div>
</div>
