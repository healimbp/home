---
title: "감정 기복과 분노 조절 장애, [인천 간석동 우울증] 간화(肝火)를 식히는 맞춤 한약 처방"
...
<div class="toc">
  ...
  <ol>
    <li>분노 조절 및 간열 해소의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 분노 조절 및 간열 해소의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 분노 조절 및 간열 해소의 악순환 진행 고리</div>
