...
<div class="intro-body">
  <p>심장이 쿵쾅거리고 손발에 땀이 흥건하며 얼굴이 화끈거려 심장내과를 찾지만, 심전도나 초음파 검사에서는 "심장은 매우 건강합니다"라는 진단을 받습니다.</p>
  <p>심장 자체의 기질적 이상이 아니라, 심장의 박동수와 혈관의 수축을 조절하는 **"자율신경계의 가속 페달(교감신경)"이 브레이크 없이 24시간 밟혀있는 상태**입니다.</p>
</div>
...
<div class="toc">
  ...
  <ol>
    ...
    <li>위는 뜨겁고 아래는 차가운 "상열하한(上熱下寒)"의 신체 불균형</li>
    <li>진료실에서 확인하는 교감신경 흥분 유발 요인</li>
    <li>한의학의 핵심 원리: 수승화강(水昇火降)과 청심안신</li>
    <li>자율신경의 시소 밸런스를 바로잡는 한방 복합 솔루션</li>
    <li>환자들이 가장 많이 묻는 현실적 질문 (FAQ)</li>
  </ol>
</div>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">교감신경 과항진의 생리: 왜 심장은 가만히 있어도 질주할까요?</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">위는 뜨겁고 아래는 차가운 "상열하한(上熱下寒)"의 신체 불균형</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">진료실에서 확인하는 교감신경 흥분 유발 요인</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">한의학의 핵심 원리: 수승화강(水昇火降)과 청심안신</h2>
  
  <div class="grid grid-cols-1 gap-4 my-6">
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        <span class="text-xl">🔥</span>
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">심화항성(心火亢盛)형 – 가슴이 뛰고 입이 마르며 잠을 못 이루는 유형</h3>
      </div>
    ...
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        ...
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">음허화왕(陰虛火旺)형 – 오후나 밤만 되면 얼굴로 열이 오르고 식은땀이 나는 유형</h3>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8">
    ...
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        <span class="text-xl">⚡</span>
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">간양상항(肝陽上亢)형 – 감정 조절이 어렵고 욱하면 머리가 깨질 듯 아픈 유형</h3>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8">
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">자율신경의 시소 밸런스를 바로잡는 한방 복합 솔루션</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">환자들이 가장 많이 묻는 현실적 질문 (FAQ)</h2>
