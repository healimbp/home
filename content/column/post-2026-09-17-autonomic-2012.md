---
title: "앉았다 일어설 때 눈앞이 하얘지는 기립성 어지럼증과 자율신경 밸런스 회복 (인천 루원시티 치료 가이드)"
...
<div class="toc">
  ...
  <ol>
    <li>기립성 저혈압 및 심박 변이도 개선의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 기립성 저혈압 및 심박 변이도 개선의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 기립성 저혈압 및 심박 변이도 개선의 악순환 진행 고리</div>
