---
title: "[인천 부평한의원 소아청소년] 청소년기 복합 틱장애와 자존감 회복, 두뇌 신경망 1:1 맞춤 치료"
...
tags: ["인천 부평한의원","부평한의원","소아청소년한의원","맞춤한약","체열검사"]
---
...
진료실에는 **인천 부평**뿐만 아니라 인근 생활권에서 소아청소년 & 성인 ADHD·틱장애 증상으로 고통받는 많은 환자분들이 내원하십니다.
...
<div class="toc">
  ...
  <ol>
    <li>청소년 복합틱 및 학습집중력의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 청소년 복합틱 및 학습집중력의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 청소년 복합틱 및 학습집중력의 악순환 진행 고리</div>
...
<div class="my-6 p-5 bg-[#FAFBF9] rounded-2xl border border-[#E2EAE5] space-y-3 not-prose">
  <div class="font-extrabold text-[#2F5D50] text-sm sm:text-base flex items-center gap-2">
    ...
    <span>진료실에서 체크하는 소아청소년 & 성인 ADHD·틱장애 자가진단 항목</span>
  </div>
...
<div class="my-6 p-5 bg-white rounded-2xl border-2 border-[#2F5D50]/30 shadow-sm space-y-3 not-prose">
  ...
  <div class="space-y-2">
      <div class="flex items-start gap-2 text-xs sm:text-sm text-[#26332E] font-medium"><span class="text-[#2F5D50]">📄</span><span>소아청소년 & 성인 ADHD·틱장애 환자에 대한 체질 맞춤 한약 및 한방 복합 치료 시 증상 평가 척도 78% 유의미 호전</span></div>
