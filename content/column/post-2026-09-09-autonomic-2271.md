---
title: "쉬어도 쉬어도 풀리지 않는 만성 피로, 자율신경실조증 3단계 소진 자가진단 (시흥 장현 치료 가이드)"
...
<div class="toc">
  ...
  <ol>
    <li>만성피로와 자율신경실조증의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 만성피로와 자율신경실조증의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 만성피로와 자율신경실조증의 악순환 진행 고리</div>
