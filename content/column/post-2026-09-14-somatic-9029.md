---
title: "아침마다 턱이 뻐근하고 머리가 조여오는 이유? 수면 중 이갈이·이악물기 교정 (시흥 장현 치료 가이드)"
...
<div class="toc">
  ...
  <ol>
    <li>이갈이·이악물기 및 교근 긴장의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 이갈이·이악물기 및 교근 긴장의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 이갈이·이악물기 및 교근 긴장의 악순환 진행 고리</div>
