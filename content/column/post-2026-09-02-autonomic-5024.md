...
<div class="toc">
  ...
  <ol>
    <li>미주신경성 실신 및 기립성 어지럼증의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 미주신경성 실신 및 기립성 어지럼증의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 미주신경성 실신 및 기립성 어지럼증의 악순환 진행 고리</div>
