---
title: "악몽과 가위눌림, [인천 간석동 불면증] 심비양허를 보강하여 깊은 델타파 숙면 유도"
...
<div class="toc">
  ...
  <ol>
    <li>다몽증 및 렘수면 행동장애의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 다몽증 및 렘수면 행동장애의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 다몽증 및 렘수면 행동장애의 악순환 진행 고리</div>
