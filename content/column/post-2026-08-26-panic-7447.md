---
title: "[인천 계양구 공황] 문 잠갔을까 끊임없이 의심되는 확인 강박사고의 뇌 회로 안정법"
...
<div class="toc">
  ...
  <ol>
    <li>강박장애 및 CSTC 회로 과열의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 강박장애 및 CSTC 회로 과열의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 강박장애 및 CSTC 회로 과열의 악순환 진행 고리</div>
