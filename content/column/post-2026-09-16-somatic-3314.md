---
title: "목덜미가 뻣뻣하고 눈이 빠질 듯 아픈 후두신경통·경추성 두통 한방 치료 (부천 송내 치료 가이드)"
...
<div class="toc">
  ...
  <ol>
    <li>경추성 긴장성 두통 및 후두신경통의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 경추성 긴장성 두통 및 후두신경통의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 경추성 긴장성 두통 및 후두신경통의 악순환 진행 고리</div>
...
<div class="space-y-4 my-6 not-prose">
    <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] shadow-sm space-y-2">
      <div class="font-extrabold text-sm sm:text-base text-[#202947] flex items-start gap-2.5">
        ...
        <span>컴퓨터나 스마트폰을 볼 때 두통을 예방하는 가장 좋은 목 스트레칭은 무엇인가요?</span>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8 m-0">
        턱을 목 쪽으로 당겨 목 뒤를 길게 늘려주는 "친 턱(Chin-tuck)" 동작을 1시간마다 10초씩 유지해주시면 상부 경추의 신경 압박을 크게 줄일 수 있습니다.
      </p>
    </div>
    <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] shadow-sm space-y-2">
      <div class="font-extrabold text-sm sm:text-base text-[#202947] flex items-start gap-2.5">
        <span class="bg-[#2F5D50] text-white text-xs px-2 py-0.5 rounded-md font-bold shrink-0 mt-0.5">Q2</span>
        <span>뒷목과 어깨가 돌덩이처럼 뭉치면서 뒤통수와 정수리, 눈 주변까지 욱신거리는 경추성 두통은 왜 생기나요?</span>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8 m-0">
        경추 1-2-3번 신경이 후두부와 두피, 눈 주변 신경과 하나로 연결되어 있기 때문입니다. 목 근육이 긴장하여 대후두신경과 소후두신경을 압박하면 통증이 눈과 정수리로 방사됩니다. 경추 추나요법과 후두하근 이완 치료로 즉각적인 경감을 얻을 수 있습니다.
      </p>
    </div>
    <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] shadow-sm space-y-2">
      <div class="font-extrabold text-sm sm:text-base text-[#202947] flex items-start gap-2.5">
        <span class="bg-[#2F5D50] text-white text-xs px-2 py-0.5 rounded-md font-bold shrink-0 mt-0.5">Q3</span>
        <span>두통약을 매일 먹어도 듣지 않고 오히려 머리가 더 아픈 약물과용 두통은 어떻게 대처하나요?</span>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8 m-0">
        진통제를 월 10~15일 이상 장기 복용하면 뇌의 통증 억제 시스템이 마비되어 "약물 과용 두통(MOH)"이 발생합니다. 진통제를 서서히 끊고 경추 신경 압박 해소와 어혈(瘀血)을 제거하는 한약 치료로 전환해야 합니다.
      </p>
    </div>
</div>
