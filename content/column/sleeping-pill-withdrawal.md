...
<div class="intro-body">
  <p>스틸녹스(졸피뎀), 자낙스, 리보트릴 등 수면제와 신경안정제는 급성 불면증에 단기적인 구원투수가 될 수 있습니다. 하지만 복용 기간이 3개월, 1년 이상 길어지면 **약물 내성(Tolerance)과 신체적 의존성(Dependence)**이 발생합니다.</p>
  <p>가장 위험한 것은 무턱대고 약을 끊었을 때 나타나는 **"반동성 불면(Rebound Insomnia)"**입니다. 뇌가 스스로 잠드는 법을 잊어버린 상태에서 갑자기 약을 끊으면 이전보다 몇 배 더 극심한 불면과 공황이 찾아옵니다.</p>
</div>
...
<div class="toc">
  ...
  <ol>
    ...
    <li>하루아침에 끊으면 절대 안 되는 이유: 반동성 불면과 금단 증상</li>
    <li>진료실에서 설계하는 안전한 수면제 단약(Tapering) 3단계 원칙</li>
    <li>GABA 수용체의 자생력을 되살리는 한방 청열보혈안신 프로토콜</li>
    <li>수면제 장기 복용으로 인한 브레인포그와 인지 기능 회복</li>
    <li>수면제 단약을 결심한 분들이 가장 많이 묻는 질문 (FAQ)</li>
  </ol>
</div>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">수면제가 뇌를 잠재우는 원리와 장기 복용 시 발생하는 치명적 문제</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">하루아침에 끊으면 절대 안 되는 이유: 반동성 불면과 금단 증상</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">진료실에서 설계하는 안전한 수면제 단약(Tapering) 3단계 원칙</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">GABA 수용체의 자생력을 되살리는 한방 청열보혈안신 프로토콜</h2>
  
  <div class="grid grid-cols-1 gap-4 my-6">
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        <span class="text-xl">🌱</span>
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">1단계: 병행 투약기 (Brain Recovery)</h3>
      </div>
    ...
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        <span class="text-xl">📉</span>
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">2단계: 점진적 감약기 (Gradual Tapering)</h3>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8">
    ...
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        ...
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">3단계: 완전 단약 및 안정기 (Natural Sleep)</h3>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8">
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">수면제 장기 복용으로 인한 브레인포그와 인지 기능 회복</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">수면제 단약을 결심한 분들이 가장 많이 묻는 질문 (FAQ)</h2>
