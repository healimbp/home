...
<div class="toc">
  ...
  <ol>
    ...
    <li>수면 구조의 붕괴: 깊은 3단계 서파 수면의 소실</li>
    <li>진료실에서 확인하는 새벽 각성 유발 신체 신호</li>
    <li>한의학에서 바라보는 간음부족(肝陰不足)과 심화내치</li>
    <li>새벽까지 끊김 없는 7시간 통잠을 완성하는 한방 프로토콜</li>
    <li>수면유지장애 환자가 가장 많이 묻는 현실적 질문 (FAQ)</li>
  </ol>
</div>
