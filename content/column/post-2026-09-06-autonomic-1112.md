---
title: "조용한 밤마다 더 커지는 귓속 삐 소리, 신경성 이명과 뇌명증 한방 치료 원리 (인천 루원시티 치료 가이드)"
...
<div class="toc">
  ...
  <ol>
    <li>신경성 이명 및 내이 혈류장애의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 신경성 이명 및 내이 혈류장애의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 신경성 이명 및 내이 혈류장애의 악순환 진행 고리</div>
