---
title: "[인천 계양구한의원 공황] 사소한 일에도 최악을 상상하는 범불안장애와 자율신경 과흥분 조절"
...
<div class="toc">
  ...
  <ol>
    <li>만성 불안 및 편도체 안정의 신경학적 핵심 원인과 진행 메커니즘</li>
...
## 만성 불안 및 편도체 안정의 신경학적 핵심 원인과 진행 메커니즘

<div class="my-6 p-4 sm:p-5 bg-[#F2F7F4] rounded-2xl border border-[#DDE6E1] not-prose">
  <div class="text-xs font-bold text-[#2F5D50] mb-3 text-center">📊 만성 불안 및 편도체 안정의 악순환 진행 고리</div>
