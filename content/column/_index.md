        ...
        <div class="w-full max-w-5xl mx-auto py-6 space-y-12">
          ...
          <div class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="column-grid">
              ...
              <!-- [SEO 자동발행: 소아 틱장애 · ADHD - 2026-08-22] -->
              <article class="column-item tic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                <div class="space-y-2.5">
                  ...
                  <h3 class="text-base sm:text-lg font-extrabold text-[#26332E] leading-snug cursor-pointer hover:text-[#2F5D50] transition">
                    <a href="/column/post-2026-08-22-tic-2206/" class="hover:underline">[부천 상동 소아 한의원] 청소년기 복합 틱장애와 자존감 회복, 두뇌 신경망 1:1 맞춤 치료</a>
                  </h3>
                  <p class="text-xs sm:text-sm text-[#53615B] leading-relaxed">
                    부천 상동 지역에서 소아 틱장애 · ADHD 증상으로 한의원 및 병원 치료를 찾는 분들을 위한 권형근 대표원장의 심층 원인 분석과 1:1 맞춤 한방 치료 가이드입니다.
                  </p>
                </div>
                <div class="pt-3 border-t border-[#F2F7F4] flex items-center justify-between">
                  <span class="text-[11px] text-[#68736E]">• 부천 상동한의원 • 부평한의원 • 소아 • 맞춤한약 • 뇌파검사 • 체열검사</span>
                  <a href="/column/post-2026-08-22-tic-2206/" class="inline-flex items-center gap-1 text-xs font-bold text-[#2F5D50] bg-[#EAF3EF] px-3 py-1.5 rounded-lg hover:bg-[#2F5D50] hover:text-white transition">
                    <span>칼럼 전문 읽기</span>
              ...
              <!-- [SEO 자동발행: 자율신경 · 실신/어지럼증 - 2026-08-22] -->
              <article class="column-item autonomic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                <div class="space-y-2.5">
                  ...
                  <h3 class="text-base sm:text-lg font-extrabold text-[#26332E] leading-snug cursor-pointer hover:text-[#2F5D50] transition">
                    <a href="/column/post-2026-08-22-autonomic-8984/" class="hover:underline">[구월동 자율신경 한의원] 긴장하면 손발에 땀 쏟아지는 수족다한증, 교감신경 긴장 완화 처방</a>
                  </h3>
                  <p class="text-xs sm:text-sm text-[#53615B] leading-relaxed">
                    구월동 지역에서 자율신경 · 실신/어지럼증 증상으로 한의원 및 병원 치료를 찾는 분들을 위한 권형근 대표원장의 심층 원인 분석과 1:1 맞춤 한방 치료 가이드입니다.
                  </p>
                </div>
                <div class="pt-3 border-t border-[#F2F7F4] flex items-center justify-between">
                  <span class="text-[11px] text-[#68736E]">• 구월동한의원 • 부평한의원 • 자율신경 • 맞춤한약 • 뇌파검사 • 체열검사</span>
                  <a href="/column/post-2026-08-22-autonomic-8984/" class="inline-flex items-center gap-1 text-xs font-bold text-[#2F5D50] bg-[#EAF3EF] px-3 py-1.5 rounded-lg hover:bg-[#2F5D50] hover:text-white transition">
                    <span>칼럼 전문 읽기</span>
                    <i class="fa-solid fa-arrow-right text-[10px]"></i>
                  </a>
                </div>
