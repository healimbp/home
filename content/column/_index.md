        ...
        <div class="w-full max-w-5xl mx-auto py-6 space-y-12">
          ...
          <div class="space-y-8">
            <div class="flex items-center justify-between flex-wrap gap-3 border-b border-[#DDE6E1] pb-4">
              ...
              <div class="text-xs text-[#68736E]">카드를 클릭하면 홈페이지에서 바로 2,000자급 심층 전문을 읽으실 수 있습니다.</div>
            </div>
            ...
            <!-- 칼럼 카드 그리드 (모든 칼럼 2,000자급 심층 의학 콘텐츠 탑재) -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="column-grid">
              ...
              <article class="column-item panic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                ...
                <div id="data-col-panic-1" style="display:none;" 
                     ...
                     data-summary="인천 부평 공황장애 한의원에서 전하는 공황발작 시 교감신경 과흥분을 진정시키는 4-7-8 복식호흡과 뇌 변연계 안정 한방 치료 프로토콜입니다." 
                     data-tags="인천공황장애한의원, 부평공황장애병원, 공황발작치료, 자율신경실조증, 한방신경정신과">
                  <p>안녕하세요. <strong>부평역 7번 출구에서 자율신경 및 신경정신과 질환을 1:1 진료하는 해아림한의원 인천부평점 대표원장 권형근(한방침구과 전문의)</strong>입니다.</p>
                  ...
                  <h3 class="text-lg font-extrabold text-[#2F5D50] mt-6 mb-3 border-b border-[#DDE6E1] pb-2">4. 일상생활 속 회복 가이드</h3>
                  <p>카페인(커피, 에너지음료)과 알코올은 뇌 신경계를 자극하여 공황 발작의 방아쇠가 됩니다. 치료 중에는 카페인을 완전히 중단하시고, 하루 30분 햇볕을 쬐며 걷는 가벼운 산책으로 세로토닌 분비를 촉진해 주시는 것이 좋습니다.</p>
                </div>
              </article>
              ...
              <article class="column-item panic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                <div class="space-y-2.5">
                  ...
                  <p class="text-xs sm:text-sm text-[#53615B] leading-relaxed">
                    발작이 없는 시간에도 일상을 마비시키는 24시간 예기불안의 악순환 고리와 뇌 해마의 공포 기억을 지우는 한방 치료를 설명합니다.
                  </p>
                </div>
                <div class="pt-3 border-t border-[#F2F7F4] flex items-center justify-between">
                ...
                <div id="data-col-panic-2" style="display:none;" 
                     ...
                     data-summary="인천 구월동 불안장애 한의원에서 전하는 예기불안의 뇌 신경학적 원인과 안심정지 맞춤 한약 치료 솔루션입니다." 
                     data-tags="구월동불안장애, 인천공황장애한의원, 예기불안치료, 안심정지, 한방신경정신과">
                  <p>안녕하세요. <strong>부평역 7번 출구에서 구월동, 간석동 환자분들의 불안신경증을 1:1 진료하는 해아림한의원 대표원장 권형근(한방침구과 전문의)</strong>입니다.</p>
                  
                  <blockquote class="bg-[#F2F7F4] border-l-4 border-l-[#2F5D50] p-4 rounded-r-xl my-4 text-[#3D4D47] text-sm leading-relaxed italic">
                    &ldquo;지금은 발작이 없는데도 '혹시 운전하다가 또 숨이 막히면 어떡하지?'라는 생각에 하루 종일 가슴이 조마조마합니다.&rdquo;<br>
                  ...
                  <ul class="list-disc pl-5 space-y-2 text-sm text-[#4E6159] my-3">
                    ...
                    <li><strong>두개천골 추나요법</strong>: 뇌척수액 순환을 개선하여 뇌 피로를 씻어냅니다.</li>
                  </ul>

                  <h3 class="text-lg font-extrabold text-[#2F5D50] mt-6 mb-3 border-b border-[#DDE6E1] pb-2">3. 원장의 진료 조언</h3>
                  <p>예기불안은 환자분의 의지가 약해서 생기는 것이 아닙니다. 뇌의 신경전달물질과 자율신경계가 과열되어 일어나는 생리적 반응이므로, 정확한 한방 치료로 뇌를 안정시켜 주면 두려움 없이 가고 싶은 곳 어디든 자유롭게 다닐 수 있는 일상이 다시 시작됩니다.</p>
                </div>
              </article>
              ...
              <article class="column-item panic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                <div class="space-y-2.5">
                  ...
                  <h3 class="text-base sm:text-lg font-extrabold text-[#26332E] leading-snug cursor-pointer hover:text-[#2F5D50] transition" onclick="openColumnModal('col-panic-3')">
                    [부천 상동 사회공포증 한의원] 발표할 때 목소리 떨림과 심장 두근거림, 심담허겁 체질 한방 치료
                  </h3>
                  <p class="text-xs sm:text-sm text-[#53615B] leading-relaxed">
                    시선 공포, 무대 공포, 발표 불안은 단순 소심함이 아닌 심담허겁(心膽虛怯) 체질 질환입니다. 심장의 담력을 키우는 한방 치료법을 다룹니다.
                  </p>
                </div>
                <div class="pt-3 border-t border-[#F2F7F4] flex items-center justify-between">
                  <span class="text-[11px] text-[#68736E]">• 부천 상동 • 사회공포증 • 무대불안 극복</span>
                ...
                <div id="data-col-panic-3" style="display:none;" 
                  ...
                  <ul class="list-disc pl-5 space-y-2 text-sm text-[#4E6159] my-3">
                    ...
                    <li><strong>두개천골 추나요법</strong>: 경추 긴장을 완화하여 안면부 혈류를 정상화합니다.</li>
                  </ul>
              ...
              <article class="column-item autonomic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                ...
                <div id="data-col-autonomic-1" style="display:none;" 
                     data-title="[부평 자율신경실조증 한의원] 만성피로와 자율신경계 기능 저하는 어떤 관계일까요? 몸이 긴장에서 소진으로 가는 과정" 
                     data-category="자율신경 · 실신/어지럼증" 
                     data-date="2026.01.18" 
                     data-summary="자율신경계 기능 저하가 만성화되며 신체 에너지가 소진되는 기전과 한스 셀리에 3단계 모델, 한의학적 자생력 회복 치료를 다룹니다." 
                     data-tags="만성피로, 자율신경실조증, 한스셀리에, HRV검사, 체질맞춤한약, 브레인포그">
                  <p>안녕하세요. <strong>부평역 7번 출구에서 자율신경실조증을 1:1 진료하는 해아림한의원 인천부평점 대표원장 권형근(한방침구과 전문의)</strong>입니다.</p>
                  ...
                  <h3 class="text-lg font-extrabold text-[#2F5D50] mt-6 mb-3 border-b border-[#DDE6E1] pb-2">4. 일상생활 속 자가 관리 가이드</h3>
                  <p>매일 아침 일정한 시간에 일어나 햇볕을 15분 이상 쬐고, 미온수를 충분히 마시며 교감신경의 급격한 과열을 막는 4-7-8 호흡을 습관화해 보세요. 오래된 피로는 쉬지 못해 생긴 병이 아니라 몸의 조절 능력이 고장 난 신호입니다.</p>
                </div>
              </article>
              ...
              <article class="column-item autonomic heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                ...
                <div id="data-col-autonomic-2" style="display:none;" 
                     data-title="[청라 어지럼증 한의원] 출퇴근길 지하철에서 핑 돌고 쓰러지는 미주신경성 실신, 전조증상과 한방 치료" 
                     data-category="자율신경 · 실신/어지럼증" 
                     data-date="2026.01.05" 
                     data-summary="미주신경성 실신의 전조 증상 대처법과 심비양허 체질 개선 및 혈관 탄력을 높이는 한방 치료를 다룹니다." 
                     data-tags="청라어지럼증한의원, 미주신경성실신, 기립성저혈압, 자율신경검사, 혈류개선">
                  <p>안녕하세요. <strong>해아림한의원 인천부평점 대표원장 권형근(한방침구과 전문의)</strong>입니다.</p>
              ...
              <article class="column-item insomnia heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                ...
                <div id="data-col-insomnia-1" style="display:none;" 
                     ...
                     data-tags="계양구불면증한의원, 불면증, 수면장애, 중도각성, 허열치료, 숙면한약">
                  <p>안녕하세요. <strong>해아림한의원 인천부평점 대표원장 권형근(한방침구과 전문의)</strong>입니다.</p>
              ...
              <article class="column-item stress heal-card space-y-4 bg-white flex flex-col justify-between border border-[#DDE6E1] hover:shadow-md transition">
                ...
                <div id="data-col-stress-1" style="display:none;" 
                     ...
                     data-tags="영종도화병한의원, 화병, 울화병, 매핵기, 스트레스성가슴답답함, 분심기음">
                  <p>안녕하세요. <strong>해아림한의원 인천부평점 대표원장 권형근(한방침구과 전문의)</strong>입니다.</p>
