...
<div class="intro-body">
  <p>조금만 먹어도 배가 가득 찬 듯 답답하고, 트림과 가스가 끊이지 않으며, 명치가 돌처럼 굳어 고통받는 환자들이 많습니다.</p>
  <p>위내시경으로 위장 내부 점막을 보아도 염증이나 궤양이 없는데 왜 아플까요? 원인은 점막 표면이 아니라 **위장 바깥쪽 근육층(미세 순환계)에 노폐물이 쌓여 굳어진 "담적(痰積)"이자 "기능성 소화불량(Functional Dyspepsia)"** 때문입니다.</p>
</div>
...
<div class="toc">
  ...
  <ol>
    ...
    <li>위장 연동 운동의 마비: 왜 음식물이 십이지장으로 내려가지 못할까요?</li>
    <li>진료실 복진(腹診)으로 확인하는 담적의 3대 부위</li>
    <li>한의학에서 위장의 굳은 담적을 녹이는 평위산과 온담탕</li>
    <li>딱딱한 명치를 부드럽게 풀어주는 복부 온열 추나 & 약침</li>
    <li>소화불량 환자가 가장 많이 묻는 현실적 질문 (FAQ)</li>
  </ol>
</div>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">위내시경에 보이지 않는 위장 외벽의 비밀: 담적병(痰積病)의 정체</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">위장 연동 운동의 마비: 왜 음식물이 십이지장으로 내려가지 못할까요?</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">진료실 복진(腹診)으로 확인하는 담적의 3대 부위</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">한의학에서 위장의 굳은 담적을 녹이는 평위산과 온담탕</h2>
  
  <div class="grid grid-cols-1 gap-4 my-6">
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        <span class="text-xl">🪨</span>
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">비위기허(脾胃氣虛)형 – 선천적으로 소화기가 약하고 밥맛이 없으며 헛배 부른 유형</h3>
      </div>
    ...
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        ...
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">간위불화(肝胃不和)형 – 스트레스만 받으면 명치가 콱 막히고 체하는 신경성 유형</h3>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8">
    ...
    <div class="p-5 bg-[#F9FAF8] rounded-2xl border border-[#E2EAE5] space-y-2">
      <div class="flex items-center gap-2.5">
        <span class="text-xl">🔥</span>
        <h3 class="font-extrabold text-sm sm:text-base text-[#202947]">담열내조(痰熱內阻)형 – 속이 쓰리고 타는 듯하며 역류가 심하고 입이 쓴 유형</h3>
      </div>
      <p class="text-xs sm:text-sm text-[#4E6159] leading-relaxed pl-8">
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">딱딱한 명치를 부드럽게 풀어주는 복부 온열 추나 & 약침</h2>
...
<div class="section">
  ...
  <h2 class="text-xl sm:text-2xl font-bold text-[#26332E] pb-2 border-b border-[#DDE6E1]">소화불량 환자가 가장 많이 묻는 현실적 질문 (FAQ)</h2>
