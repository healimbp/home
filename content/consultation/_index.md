        ...
        <div class="w-full max-w-5xl mx-auto py-6 space-y-16">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="heal-card text-center space-y-4 bg-white border-t-4 border-t-[#FEE500]">
              ...
              <a href="https://pf.kakao.com/_Tcxcoxj/chat" target="_blank" rel="noopener" class="heal-btn heal-btn-kakao w-full text-sm">
            ...
            <div class="heal-card text-center space-y-4 bg-white border-t-4 border-t-[#03C75A]">
              ...
              <a href="https://booking.naver.com" target="_blank" rel="noopener" class="heal-btn heal-btn-naver w-full text-sm">
          ...
          <div class="heal-card space-y-6 bg-white shadow-sm">
            ...
            <form onsubmit="event.preventDefault(); alert('상담 신청이 정상적으로 접수되었습니다. 의료진 확인 후 남겨주신 연락처로 신속히 안내드리겠습니다.');" class="space-y-4 text-sm">
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label class="block font-bold text-[#26332E] mb-1">성함 <span class="text-red-500">*</span></label>
                  <input type="text" required placeholder="홍길동" class="w-full p-3 rounded-xl border border-[#DDE6E1] focus:outline-none focus:border-[#2F5D50] text-sm bg-[#FAF8F3]">
                </div>
                <div>
                  <label class="block font-bold text-[#26332E] mb-1">연락처 <span class="text-red-500">*</span></label>
                  <input type="tel" required placeholder="010-1234-5678" class="w-full p-3 rounded-xl border border-[#DDE6E1] focus:outline-none focus:border-[#2F5D50] text-sm bg-[#FAF8F3]">
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select required class="w-full p-3 rounded-xl border border-[#DDE6E1] focus:outline-none focus:border-[#2F5D50] text-sm bg-[#FAF8F3]">
                ...
                <div>
                  ...
                  <select class="w-full p-3 rounded-xl border border-[#DDE6E1] focus:outline-none focus:border-[#2F5D50] text-sm bg-[#FAF8F3]">
                    <option value="전화">전화 유선 안내</option>
                    <option value="문자/카카오톡">문자 / 카카오톡 메시지 안내</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea rows="4" required placeholder="언제부터 증상이 시작되었는지, 어떤 신체/심리적 불편을 겪고 계신지 편안하게 적어주세요." class="w-full p-3 rounded-xl border border-[#DDE6E1] focus:outline-none focus:border-[#2F5D50] text-sm bg-[#FAF8F3]"></textarea>
              </div>
              ...
              <div class="text-center pt-2">
                <button type="submit" class="heal-btn heal-btn-primary px-8 py-3 w-full sm:w-auto">
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs sm:text-sm">
              ...
              <div class="p-5 bg-white rounded-2xl border border-[#DDE6E1] space-y-2">
                ...
                <p class="text-[#68736E] leading-relaxed">
                  첫 내원 시 정밀 설문지 작성, 뇌파 및 자율신경 검사, 원장님과의 1:1 심층 맥진 및 상담, 침구 치료까지 포함하여 약 1시간 ~ 1시간 30분 정도 소요됩니다.
                </p>
              </div>
            </div>
          </div>
